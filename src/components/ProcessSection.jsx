...
<div className="lg:col-span-6">
  <div className="flex gap-2"> 
    ...
    <div className="flex flex-row gap-6">
      ...
      <span className="text-black text-xs"> {number} </span>
    </div>

    <h3 className="text-lg font-sans text-gray-300">{title}</h3> 

    <div className="mt-2">
      <button className="px-2 py-1 bg-blue-500 text-sm rounded">
        View
        <ArrowRight size={24} /> 
      </button>
    </div>
